...
qq.FileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        (!this._options.button ? '<div class="ui floated primary labeled icon button qq-upload-button"><i class="video play outline icon"></i> {uploadButtonText}</div>' : '') +
            (!this._options.listElement ? '<ul class="qq-upload-list"></ul>' : '') +
            '</div>',

        // template for one item in file list
        fileTemplate: '<li>' +
            '<div class="ui indicating progress" id="qq-progress-bar"><div class="bar qq-progress-bar"><div class="progress"></div></div></div>' +
...
qq.extend(qq.FileUploader.prototype, {
    ...
    _onComplete: function(id, fileName, result){
        ...
        if (result.success) {
            ...
            if (this._options.onCompleteCallback != null)
            {
                this._options.onCompleteCallback(result);
            }
    ...
    _addToList: function(id, fileName){
        ...
        if (this._options.onSubmitCallback != null) {
            this._options.onSubmitCallback();
        }
    },
    _clearList: function(){
        this._listElement.innerHTML = '';
    ...
    _controlFailureTextDisplay: function (item, response) {
        $('#errorMessage').html(JSON.stringify(response));
